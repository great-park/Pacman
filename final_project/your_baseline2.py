...
class parentAgent(CaptureAgent):
    """
    baseline.py의 ReflexCaptureAgent 수정. 공격자와 방어자의 기본이 되는 부모 클래스입니다.
    probability를 선언하여 임의로 적당한 확률값을 설정하고,
    util의 filpCoin 사용하여 간편하게 확률을 구현하였습니다.
    """
    ...
    def chooseAction(self, gameState):
        ...
        # 확률 88.7% => 약 11.3%의 확률로 랜덤한 action을 취하도록 설정하였다.
        probability = 0.887
